...
import { ImageBanner, SectionHeader, HeroImage } from '../components/web';
import Iframe from 'react-iframe'


export async function getStaticProps() {

  const researchJSON = require('../content_old/research.json');
  const projJSON = require('../content_old/projects/full.json');
