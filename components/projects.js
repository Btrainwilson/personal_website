...
export default function ProjectCard({project, target="_self"}) {
  return (
      ...
      <a href={project.url} target={target} class="shadow-md w-60 m-4 bg-white border hover:bg-gray-600 border-gray-200 rounded-lg shadow bg-gray-800 border-gray-700">
        <div>
          ...
          <div class="p-3 rounded-lg ">
              ...
              <p class="mb-3 font-normal text-gray-700 text-gray-400">{project.description}</p>
          </div>
        </div>
      </a>
